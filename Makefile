...
ifeq ($(BR2_TOOLCHAIN_HAS_THREADS),y)
	...
	echo "$(BR2_VERSION)" > $(TARGET_DIR)/etc/cargos-release
	...
	@$(call MESSAGE,"Re-finalizing target directory")
	$(foreach hook,$(TARGET_REFINALIZE_HOOKS),$($(hook))$(sep))
